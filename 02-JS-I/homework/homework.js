...
const nuevaString = "soy un henry";
...
function elevar(num, exponent) {
  ...
  // Tu código:
  var elevacionnum = Math.pow (num,exponent);
  return elevacionnum;
}
...
function obtenerSaludo(nombre) {
  ...
  // "Martin" -> "Hola Martin!"
  // Tu código:
  var informacion = nombre;
  return "Hola " + informacion + "!";
}
